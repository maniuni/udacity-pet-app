...
public class PetCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        // Extract properties from cursor for the current pet
        String petName = cursor.getString(cursor.getColumnIndex(PetsEntry.COLUMN_PET_NAME));
        String petSummary = cursor.getString(cursor.getColumnIndex(PetsEntry.COLUMN_PET_BREED));
        ...
        petSummaryTextView.setText(petSummary);
    }
}